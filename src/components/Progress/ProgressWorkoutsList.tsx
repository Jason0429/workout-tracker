	...
	return (
		...
		>
			<Typography
				align='center'
				p={1}
				color={progressPageState.workoutsOnThisDay.value.length > 0 ? "#00bfff" : "#ff726f"}
			>
				{progressPageState.workoutsOnThisDay.value.length > 0
					? "Workouts On This Day:"
					: "No Workouts On This Day"}
			</Typography>
			<Divider />
			<List sx={{ width: "350px", padding: "0" }}>
				{progressPageState.workoutsOnThisDay.value.map(
